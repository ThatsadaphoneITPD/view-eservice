    ...
    >
      <div className="sticky top-0 z-40 bg-gray-0/10 px-6 pb-5 pt-5 dark:bg-gray-100/5 2xl:px-8 2xl:pt-6">
        <Link href={'/'} aria-label="Site Logo">
          <Image src="/home_logo.png" alt="logo" height={100} width={200} />
              ...
              <Fragment key={item.name + '-' + index}>
                {item?.href ? (
                          ...
                          return (
                            ...
                            >
                              ...
                              {dropdownItem?.icon && (
                                <span
                                  className={cn(
                                    'me-2 inline-flex ml-4 h-3 w-3 items-center justify-center rounded-md [&>svg]:h-[19px] [&>svg]:w-[19px]',
                                    isActive
                                      ? 'text-primary'
                                      : 'text-gray-800 dark:text-gray-500 dark:group-hover:text-gray-700'
                                  )}
                  ...
                  <Title
                    as="h6"
                    className={cn(
                      'mb-2 truncate px-6 py-2 text-[15px] font-bold bg-gray-100 uppercase tracking-widest text-gray-500 dark:text-gray-500 2xl:px-8',
